...
constant slow inward current (SIC). It can be used for benchmarking of
...
class astrocyte_surrogate : public StructuralPlasticityNode
{

public:
  astrocyte_surrogate();
  astrocyte_surrogate( const astrocyte_surrogate& );
  //~astrocyte_surrogate() override;
...
public:
  ...
  struct Buffers_
  {
    ...
    Buffers_( const Buffers_&, astrocyte_surrogate& ); //!< Sets buffer pointers to 0
